...
./uniform_sampling/uniform_sampling_kUFL_LocalSearch/uniform_sampling_kUFL_LocalSearch 1 ${Data_Path} >> ${kUFL_Path}uniform_sampled_wikipedia.out &
./uniform_sampling/uniform_sampling_Rec_LocalSearch/uniform_sampling_RecLocalSearchEval 1 ${Data_Path} >> ${Rec_Path}uniform_sampled_wikipedia.out &
