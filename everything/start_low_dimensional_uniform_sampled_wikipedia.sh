...
./uniform_sampling/uniform_sampling_kUFL_LocalSearch/uniform_sampling_kUFL_LocalSearch ${Data_Path} 1 >> ${kUFL_Path}uniform_sample_lower_dimensions_Wikipedia.out &
./uniform_sampling/uniform_sampling_Rec_LocalSearch/uniform_sampling_RecLocalSearchEval ${Data_Path} 1 >> ${Rec_Path}uniform_sample_lower_dimensions_Wikipedia.out &
