...
./sample/sample_kUFL_LocalSearch/sample_kUFL_LocalSearch ${Data_Path} 1 >> ${kUFL_Path}sample_twitter.out &
./sample/sample_Rec_LocalSearch/sample_RecLocalSearchEval ${Data_Path} 1 >> ${Rec_Path}sample_twitter.out &
